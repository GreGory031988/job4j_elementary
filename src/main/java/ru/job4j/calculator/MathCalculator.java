...
public class MathCalculator {
    ...
    public static double differanceExpression(double first, double second) {
        return sum(first, second)
                + multiply(first, second)
                + minus(first, second)
                + division(first, second);
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Результат расчета differanceExpression равен: " + differanceExpression(10, 20) + ".");
    }
}
